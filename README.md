...
- replay всегда захватывает выбранный монитор и не переключается на фоновые окна;
...
В фоне пишется временный MP4 выбранного монитора с теми же видео- и аудионастройками. По команде файл
...
GitHub Actions проверяет проект при каждом push и pull request. Тег вида `v0.3.0`
