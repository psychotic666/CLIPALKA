...
- автоматический приоритет крупного окна игры с резервным захватом монитора;
- имена файлов вида `Название игры Replay - 2026-09-22 18-42-10.mp4`;
- H.264 High Profile, quality-based VBR до 36 Мбит/с и stereo 192 kbps;
...
GitHub Actions проверяет проект при каждом push и pull request. Тег вида `v0.2.0`
